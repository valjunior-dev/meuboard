...
public class BoardColumnDAO {
    ...
    public BoardColumnEntity insert(final BoardColumnEntity entity) throws SQLException {
        var sql = "INSERT INTO BOARDS_COLUMNS (name, column_order, kind, board_id) VALUES (?, ?, ?, ?);";
        try (var statement = connection.prepareStatement(sql)) {
            var i = 1;
            statement.setString(i++, entity.getName());
            statement.setInt(i++, entity.getColumnOrder());  // ALTERE para getColumnOrder() no Entity
    ...
    public List<BoardColumnEntity> findByBoardId(final Long boardId) throws SQLException {
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            while (resultSet.next()) {
                ...
                entity.setColumnOrder(resultSet.getInt("column_order")); // ALTERE para setColumnOrder() no Entity
